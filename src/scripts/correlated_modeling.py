...
#ACE_data = ACE_data[(ACE_data.index>= start_check) & (ACE_data.index <=end_check)] #Todo: Get this to work and add to weather data too. For some reason it doesn't recognize the ACE index as a datetime object
